      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.topHeader}>
          ...
          <View style={styles.stepPillBadge}>
            <Text style={styles.stepPillText}>07 / 13</Text>
          </View>
        </View>
          ...
          <PremiumCard variant="glass" style={styles.glassCardContainer}>
            <View style={styles.badgeWrapper}>
              <View style={styles.glowingVectorCircle}>
                <MaterialCommunityIcons name="head-heart-outline" size={30} color="#FFFFFF" />
              </View>
            </View>
            ...
            {/* Family Status */}
            <Text style={styles.sectionHeaderLabel}>Family Financial Status</Text>
            <View style={styles.chipsWrapRow}>
              {familyStatuses.map((fs) => (
                <TouchableOpacity
                  key={fs}
                  style={[styles.glassChip, familyStatus === fs && styles.glassChipSelected]}
                  onPress={() => setFamilyStatus(fs)}
                >
                  <Text style={[styles.glassChipText, familyStatus === fs && styles.glassChipTextSelected]}>{fs}</Text>
                </TouchableOpacity>
              ))}
            </View>
            ...
            <View style={styles.glassInputWrapper}>
              ...
              <TextInput
                ...
                placeholder="Enter native place (e.g. Jodhpur, Pali, Nagaur)"
            ...
            {/* About Me Bio */}
            <Text style={styles.sectionHeaderLabel}>About Yourself (Short Bio)</Text>
            <View style={[styles.glassInputWrapper, { alignItems: 'flex-start', paddingTop: 12 }]}>
              <MaterialCommunityIcons name="pencil-outline" size={20} color="#4169D8" style={{ marginRight: 10, marginTop: 2 }} />
              <TextInput
                style={[styles.inputField, { height: 90, textAlignVertical: 'top' }]}
                placeholder="Write a few lines about your personality, values, and life goals..."
                multiline
                numberOfLines={4}
                value={aboutMe}
