...
export default function Step11() {
  ...
  const [email, setEmail] = useState('arjun.singh@example.com');
        ...
        <ScrollView contentContainerStyle={styles.contentScroll} showsVerticalScrollIndicator={false}>
          <View style={styles.glassCardContainer}>
            ...
            <View style={styles.headerTitleBox}>
              ...
              <Text style={styles.questionSubtitle}>Set up your account details to complete profile</Text>
            </View>

            {/* Full Name */}
            <Text style={styles.sectionHeaderLabel}>Your Full Name</Text>
            <View style={styles.glassInputWrapper}>
              <MaterialCommunityIcons name="account-outline" size={20} color="#FF85A1" style={{ marginRight: 10 }} />
              <TextInput
            ...
            <View style={styles.glassInputWrapper}>
              <MaterialCommunityIcons name="email-outline" size={20} color="#FF85A1" style={{ marginRight: 10 }} />
              <TextInput
                style={styles.inputField}
            ...
            {/* Password */}
            <Text style={styles.sectionHeaderLabel}>Create Account Password</Text>
            <View style={styles.glassInputWrapper}>
              <MaterialCommunityIcons name="lock-outline" size={20} color="#FF85A1" style={{ marginRight: 10 }} />
              <TextInput
                style={styles.inputField}
        ...
        <View style={styles.footerContainer}>
          <View style={styles.progressRow}>
            <View style={styles.progressTrackBg}>
              <View style={[styles.progressBarFill, { width: `${(11 / 13) * 100}%` }]} />
            </View>
